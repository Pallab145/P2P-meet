  ...
  return (
    <div className="bg-gray-800 text-white h-screen w-screen flex flex-col">
      ...
      <div className="bg-slate-500 text-white p-4 w-full flex justify-center space-x-4">
        <div>
          <button onClick={handleMicrophone} className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
            <img src={microphoneActive ? "microphone.png" : "mute.png"} alt="microphone" className="h-10 w-10 mx-4" />
          </button>
        </div>

        <div>
          <button onClick={handleVideo} className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
            <img src={videoActive ? "video-call.png" : "video.png"} alt="video-call" className="h-10 w-10 mr-4" />
          </button>
        </div>

        <div>
          <button onClick={handleShareScreen} className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
            <img src={shareScreenActive ? "share-screen.png" : "stop-screen-share.png"} alt="share screen" className="h-10 w-10 mr-4" />
          </button>
        </div>
